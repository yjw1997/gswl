  ...
  <div class="page-header-index-wide">
    <a-card :bordered="false" :bodyStyle="{ padding: '16px 0', height: '100%' }" :style="{ height: '100%' }">
      <div class="account-settings-info-main" :class="device" :style=" 'min-height:'+ mainInfoHeight ">
        <div class="account-settings-info-left" v-if="userInfo.username === 'admin'">
          <a-menu
          ...
          >
            <a-menu-item key="/account/settings/base">
              ...
              <router-link :to="{ name: 'account-settings-company' }">
                公司资料
              </router-link>
            </a-menu-item>
        ...
        <div class="account-settings-info-left" v-else>
          <a-menu
            :mode="device == 'mobile' ? 'horizontal' : 'inline'"
            :style="{ border: '0', width: device == 'mobile' ? '560px' : 'auto'}"
            :defaultSelectedKeys="defaultSelectedKeys"
...
export default {
  ...
  data () {
    return {
      ...
      mainInfoHeight: '100%',
      openKeys: [],
      defaultSelectedKeys: ['/account/settings/company'],
