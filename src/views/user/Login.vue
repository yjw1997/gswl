    ...
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin">
      ...
      <a-row :gutter="0">
        ...
        <a-col :span="8" style="text-align: right">
          <img v-if="requestCodeSuccess" style="height:40px" :src="randCodeImage" @click="handleChangeCheckCode" />
      ...
      <!-- <a-tab-pane key="tab1" tab="高速物流网络货运平台">
      ...
      <a-form-item>
        <a-checkbox style="color:#fafafa" v-decorator="['rememberMe', { initialValue: true, valuePropName: 'checked' }]">自动登陆</a-checkbox>
        <router-link  :to="{ name: 'alteration' }" class="forge-password" style="float: right;color:#fafafa">忘记密码</router-link>
        ...
        that.form.validateFields(
          ...
          (err, values) => {
            if (!err) {
              ...
              loginParams.password = values.password.trim()
